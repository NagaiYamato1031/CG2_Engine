...
std::wstring MyUtility::GetResourceRoot() {
	static const std::wstring kResourceRoot = L"./Resources/";
	return kResourceRoot;
}
std::string MyUtility::GetResourceRootChar() {
	static const std::string kResourceRoot = "./Resources/";
	return kResourceRoot;
}
